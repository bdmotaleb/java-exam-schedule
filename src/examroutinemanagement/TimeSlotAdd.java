 ...
 * @author User
 */
public class TimeSlotAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add New Time Slot");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String start_time = jTextField1.getText();
        String end_time = jTextField2.getText();
        
        try {
            Connection con = ConnectionProvider.getCon();
            Statement stm = con.createStatement();
            
            String sql = "INSERT INTO `time_slots`( `start_time`, `end_time`) VALUES ('"+start_time+"','"+end_time+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimeSlotAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
