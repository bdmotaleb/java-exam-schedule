 ...
 * @author User
 */
public class ClassRoomUpdateRemove extends javax.swing.JFrame {

    /**
     * Creates new form TeacherUpdateRemove
     */
    public ClassRoomUpdateRemove() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Class Room Update or Remove");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (isEmpty) {
            ...
            try {
                ...
                String sql = "DELETE FROM `class_rooms` WHERE code='"+search+"'";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (isEmpty) {
            ...
            try {
                ...
                String sql = "UPDATE class_rooms SET name='"+name+"',code='"+code+"' WHERE code ='"+search+"'";
                stm.executeUpdate(sql);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql = "SELECT * FROM `class_rooms` WHERE code='"+search+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassRoomUpdateRemove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
