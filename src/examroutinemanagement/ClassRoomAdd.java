 ...
 * @author User
 */
public class ClassRoomAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add New Class Room");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql = "INSERT INTO class_rooms (name, code) VALUES ('"+name+"','"+code+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassRoomAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
