 ...
 * @author User
 */
public class SubjectUpdateRemove extends javax.swing.JFrame {

    /**
     * Creates new form TeacherUpdateRemove
     */
    public SubjectUpdateRemove() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Subject Update or Remove");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (isEmpty) {
            ...
            try {
                ...
                String sql = "DELETE FROM `subjects` WHERE code='"+search+"'";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (isEmpty) {
            ...
            try {
                ...
                String sql = "UPDATE subjects SET name='"+name+"',code='"+code+"' WHERE code ='"+search+"'";
                stm.executeUpdate(sql);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql = "SELECT * FROM `subjects` WHERE code='"+search+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubjectUpdateRemove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
